...
const Layout = () => {
  ...
  const clearResize = (resizeOrigin) => {
    ...
    <div className={`layout ${presentation ? "presentation" : ""}`}>
      {showHeader && (
        <div className="header">
          {/* Render children passed to 'header' slot */}
        </div>
      )}
      <div className="main">
        {showSide && (
          <div className="left" ref={asideRef}>
            {/* Render children passed to 'left' slot */}
            <div
        ...
        <div className="right">
          <div className="right-before">
            {/* Render children passed to 'right-before' slot */}
          </div>
          <div className="content" ref={contentRef}>
            {showEditor && (
              <div className="editor" ref={editorRef}>
                {/* Render children passed to 'editor' slot */}
              </div>
            )}
            {showView && (
              <div className="preview">
                ...
                {/* Render children passed to 'preview' slot */}
              </div>
            )}
          </div>
          {showXterm && (
            <div className="terminal" ref={terminalRef}>
              {/* Render children passed to 'terminal' slot */}
              <div
                className="sash-top"
      ...
      {showFooter && (
        <div className="footer">
          {/* Render children passed to 'footer' slot */}
        </div>
      )}
    </div>
  );
