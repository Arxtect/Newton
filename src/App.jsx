    ...
    <div className="max-w-[100vw] m-[auto]">
      <div className="h-[calc(100vh-64px)]">
        <div className="presentation-slide relative bg-white rounded-lg overflow-hidden h-full">
          <img
            src="./assets/arXtect.png"
            alt="arXtect: Shape the Future of Scholarly Publishing"
            className="w-full h-full"
          />
          <div className="absolute bottom-5 w-full left-0 text-center">
            <h1 className="text-4xl font-bold  text-white">
              arXtect: Shape the Future of Scholarly Publishing
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-8">
        ...
        <div className="flex justify-center items-center text-lg ">
          "Arxtect: Revolutionizing Academic Publishing - This cutting-edge
          platform combines a scalable LaTeX editor with a decentralized
          approach, offering token-based incentives for peer review and
          citations. It integrates a social networking aspect to foster
          community collaboration and employs advanced AI to enhance academic
          writing. Experience a new era in efficient, incentivized, and
          collaborative academic research and publication with Arxtect."
        </div>
      </div>
      {/* Solution */}
      <div className="bg-white p-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between px-8">
            <div className="md:w-1/2 pr-[80px]">
              <p className="text-lg mb-[70px]">
                A decentralized ecosystem that actively involves authors,
                editors, and reviewers, which introduces innovative new revenue
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                <img
                  ...
                  alt="Circular diagram with arrows indicating a cycle between Journal, Author, Editor, and Reviewer, with 'Activate the Whole System' in the center"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-between">
          <div className="w-1/3 bg-white p-6 shadow-xl border border-gray-300">
            ...
            <p className="mb-6 text-gray-600">
              Web 3.0 marks the next stage in the evolution of the internet,
              integrating ideas like decentralization, blockchain technology,
              and a token-based economy. This approach transforms how digital
              content generates income, ensuring a more secure and equitable
          ...
          <div className="w-1/3 bg-white p-6 shadow-xl border border-gray-300 mx-4">
            ...
            <p className="mb-6 text-gray-600">
              Artificial Intelligence is ushering in a new era of research,
              particularly with the availability of Large Language Models (LLMs)
              to researchers worldwide. These models serve as vast repositories
              of knowledge and offer assistance in diverse aspects of various
              research fields.
            </p>
            <div className="text-center  bg-gray-300">
              <IconButton>
          ...
          <div className="w-1/3 bg-white p-6 shadow-xl border border-gray-300">
            ...
            <p className="mb-6 text-gray-600">
              WebAssembly is a binary instruction format tailored for a
              stack-based virtual machine. It's created as a universal
              compilation target for high-level programming languages, e.g., C,
              C++. This technology is designed to helping to reduce server load
              and enhance front-end performance..
            </p>
            <div className="text-center  bg-gray-300">
              <IconButton>
                <ArrowDownwardIcon />
            ...
            <div className="w-1/2 pr-8">
              <ul className="list-disc pl-5 space-y-4">
                <li className="text-lg">
                  <strong>Editor:</strong> online collaborative editor with AI
                  assistant
                </li>
                <li className="text-lg">
                ...
                <li className="text-lg">
                  <strong>Publishing:</strong> decentralized scholarly
                  publishing: arXiv + peer reviewed journal
                </li>
              </ul>
            </div>
            <div className="w-1/2 pl-8">
              <button className="bg-[#cccccc] text-white font-bold py-2 px-4 rounded-full mb-3 w-full">
                Editor + arXiv
              </button>
              <button className="bg-[#b7b7b7] text-white font-bold py-2 px-4 rounded-full mb-3 w-full">
                Journal as a Service
              </button>
              <button className="bg-[#999999] text-white font-bold py-2 px-4 rounded-full w-full">
                Social Platform
              </button>
            </div>
          </div>
      ...
      <div className="bg-white p-8">
        ...
        <div className="flex flex-row justify-between">
          <div className="w-1/3  px-8 py-4">
            <img
              ...
              alt="Bar chart representing Market Size with Music, Scholarly Publishing, and SVoD categories"
              className="mb-4"
            />
          </div>
          <div className="w-1/3  px-8 py-4">
            <img
              ...
              alt="Bar chart representing Profit Margin @2022 with Spotify, RELX (Elsevier), and Netflix categories"
              className="mb-4"
            />
          </div>
          <div className="w-1/3  px-8 py-4">
            <img
              ...
              alt="Bar chart representing Market Cap @2022 with Spotify, RELX (Elsevier), and Netflix categories"
              className="mb-4"
            />
          </div>
        </div>
        <ul className="list-disc pl-6 mt-6">
          <li className="mb-2">
            Scholarly publishing has a market size as large as music industry
            and ⅓ of Subscription Video on Demand (SVoD)
          </li>
          <li className="mb-2">
            The profit margin in scholarly publishing significantly exceeds that
            of the music industry and SVoD services, resulting in scholarly
            publishing and SVoD having comparable net incomes.
          </li>
          <li>
            If the Price-to-Earnings ratio (PE) is consistent, then there should
            be a company in the scholarly publishing sector with a valuation
            comparable to Netflix's, which is around $195 billion.
          </li>
        </ul>
      </div>
      {/* Timeline  */}
      <div className=" p-8">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-4 gap-4">
            <span className="relative z-10 px-4 bg-white  text-center">
              2023
            </span>
            <span className="relative z-10 px-4 bg-white  text-center">
              2024 Q1
        ...
        <div className="flex">
          <div className="w-1/2">
            <div className="flex items-center mb-4">
              <img
                src="./assets/Pioneers2.png"
                alt="Pixelated avatar of a person wearing a hat"
                className="mr-4  w-[100px] h-[100px]"
              />
              <div>
                <h2 className="font-bold">G. Chew, PhD</h2>
                <p>
                  Serial entrepreneur, mentor@Havard Blockchain Accelerator &
                  Berkeley Blockchain Xcelerator Stanford-affiliated researcher
                  more 6 yrs experience in Web3, Stanford University
                </p>
              </div>
            </div>
            <div className="flex items-center mb-4">
              <img
                src="./assets/Pioneers3.png"
                alt="Pixelated avatar of a person with green background"
                className="mr-4  w-[100px] h-[100px]"
              />
              <div>
                <h2 className="font-bold">A. Ong</h2>
                <p>
                  Serial entrepreneur, software architect and Sr. SWE WASM,
                  database, backend services Snowflake, Amazon, UW-Madison
                </p>
              </div>
            </div>
            <div className="flex items-center mb-4">
              <img
                src="./assets/Pioneers4.png"
                alt="Animated avatar of a person with purple hair"
                className="mr-4  w-[100px] h-[100px]"
              />
              <div>
                <h2 className="font-bold">A. Lee</h2>
                <p>
                  Serial entrepreneur Operation, Business development JP Morgan,
                  UChicago
                </p>
              </div>
            </div>
            <div className="flex items-center">
              <img
                src="./assets/Pioneers5.png"
                alt="Cartoon avatar of a person with an orange background"
                className="mr-4 w-[100px] h-[100px]"
              />
              <div>
                <h2 className="font-bold">Z. Chang</h2>
                <p>
                  Serial entrepreneur, investor Product design DHVC, Stanford
                  University
                </p>
              </div>
            </div>
          ...
          <div className="w-1/2 pl-10">
            <img
              src="./assets/Pioneers1.png"
              alt="Logo of Stanford University"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex justify-center items-center w-full">
            <img
              ...
              alt="Dotted world map with market share bubbles"
