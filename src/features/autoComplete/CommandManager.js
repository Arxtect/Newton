...
import { buildIncludeCompletions } from "./snippets/buildIncludeCompletions";
...
class CommandManager {
  ...
  getCompletions(editor, session, pos, prefix, callback) {
    ...
    let newCompletions = completions.map((completion) => {
      if (completion.caption.includes(prefix)) {
        return {
          ...completion,
          score: 100,
        };
    ...
    console.log(newCompletions, "completions");
    buildIncludeCompletions(newCompletions, this.fileList);
    return callback(null, newCompletions);
  }
