...
export const collab =async () => {
    ...
    console.log(`Share the following URL with collaborators: http://your-app-url/?collectionId=${encodeURIComponent(collectionId)}&rootPath=${encodeURIComponent(rootPath)}`);
